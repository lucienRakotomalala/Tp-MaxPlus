...
Cependant, pour connaître le temps de cycle, nous devons passer par une rerésentation d'état de notre GET en (max,+) pour calculer la ou les valeurs propres. Les équations d'état du GET sont :
\begin{align*}
\left\lbrace
\begin{array}{lcl}
...
L'ordonnancement 2 n'est pas réalisable. En effet, il n'est pas compatible avec la spécification sur l'ordre dans lequel les pièces $A$ et $B$ doivent être usiné par les machines. Nous n'avons alors pas configuré 
